      ...
      <div ref={navigationBarRef} className="navigation_bar">
        <div className="absolute top-4 md:top-3 lg:top-1 xl:top-1.5 w-full h-auto flex items-center justify-center">
          ...
          <div className={toggle ? toggleNav : unToggleNav}>
            <Link href="/"><h6 className="font-normal link-item">Acasă</h6></Link>
            <Link href="/products"><h6 className="font-normal link-item">Produse</h6></Link>
            <Link href="/categories"><h6 className="font-normal link-item">Catalog</h6></Link>
            <Link href="/blog"><h6 className="font-normal link-item">Blog</h6></Link>
            <Link href="/aboutus"><h6 className="font-normal text-center link-item">Despre noi</h6></Link>
          </div>
          <div className="mr-[1.5rem] md:mr-[2rem] lg:mr-[2.5rem] gap-1 w-1/2 md:w-1/3 z-[1] flex items-center justify-end">
            <Link href="/cart" className="flex items-center relative mr-2">
            ...
            <Menu className="w-8 h-8 md:w-8 md:h-8 lg:w-10 lg:h-10 svg_icon cursor-pointer xl:hidden" onClick={handleToggle} />
          </div>
        </div>
      </div>
    </div>
