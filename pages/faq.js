...
export default function Faq() {
    return (
        <>
            <Banner />
            <Header />
                <div className="mt-[5rem] text-[#000] flex flex-col gap-10 px-4 lg:px-20">
            <Layout>
                    <div className="flex flex-col gap-6">
                        <h4 className="font-bold  text-[#000]">Procesul de livrare</h4>
                        <p className="leading-relaxed">
                            Iti multumim ca ne vizitezi si asteptam comanda ta pentru a te bucura de o experienta olfactiva si vizuala unice.
                    ...
                    <div className="flex flex-col gap-6">
                        <h4 className="font-bold  text-[#000]">Procesul de fabricație</h4>
                        <p className="leading-relaxed">
                            Maybee este o companie romaneasca mica dar avem dorinta sa cream produse unice si de calitate.
                            ...
                            Iti dorim o experienta cat mai frumoasa cu produsele noastre Maybee.
                        </p>
                    </div>

                    <div className="flex flex-col gap-6">
                        <h4 className="font-bold  text-[#000]">Politică de confidențialitate</h4>
                        <p className="leading-relaxed">
                            ...
                            E-mail: mixedarts.events@gmail.com
                        </p>
                    </div>

                    <div className="flex flex-col gap-6">
                        <h4 className="font-bold  text-[#000]">Termeni și condiții</h4>
                        <p className="leading-relaxed">
                            ...
                            <br />
                            <strong>2. DISPONIBILITATE ȘI PREȚ</strong>
                            ...
                            <br />
                            <strong>3. MODALITATE DE PLATĂ</strong>
                            ...
                            <br />
                            <strong>4. MODALITATE DE LIVRARE</strong>
                            ...
                            <br />
                            <strong>5. DREPTUL DE PROPRIETATE INTELECTUALĂ</strong>
                            ...
                            <br />
                            <strong>6. PRELUCRAREA DATELOR CU CARACTER PERSONAL</strong>
                            ...
                            <br />
                            <strong>8. LEGEA APLICABILA – JURISDICTIA</strong>
